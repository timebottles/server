...
var _piece = require('./module/piece');
...
var _NormalUpload = require('app/base/upload/NormalUpload');

var _NormalUpload2 = _interopRequireDefault(_NormalUpload);
...
function router(app) {
  ...
  // -------------------------
  // upload
  app.post('/piece/upload', _NormalUpload2.default.single('piece'), _piece2.default.uploadPiece);
